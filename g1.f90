!=============================================================================!
	subroutine g1(nvec, v, g1v, nx, dx, optx, xper)
!
...
!=============================================================================!
	...
	integer nvec, nx, optx
	logical :: xper
	real v(nvec,nx), g1v(nvec,nx), dx
...
!=============================================================================!
	subroutine cg1(nvec, v, g1v, nx, dx, optx, xper)
!
!  Take the gradient in the streamwise direction
!  updated to fourth order accurate differencing
!
